import { Stethoscope, Scissors, Heart, Activity, BedDouble, Pill, ShoppingBag, Flame, Truck } from 'lucide-react';
...
const WhatsAppButton = ({ text = "Consultar Precio" }: { text?: string }) => (
  <a 
